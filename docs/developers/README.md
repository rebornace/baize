...
面向贡献者与集成方。产品介绍与试用见仓库根目录 [README（中文）](../../README.zh-CN.md)（[English](../../README.md)）。

| 文档 | 内容 |
|------|------|
| [入门](./getting-started.md) · [EN](./getting-started.en.md) | 构建、测试、CI、贡献 |
| [配置](./configuration.md) · [EN](./configuration.en.md) | YAML / 环境变量 / CLI |
