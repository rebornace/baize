...
2. 实现计划（按 writing-plans 另开，顺序 B1）：
   ...
   - `docs/superpowers/plans/2026-09-13-f-kv-encrypt.md`（**F-KV 已交付**；DoD 见 `notes/2026-09-13-f-kv-dod-audit.md`）
   - `docs/superpowers/plans/2026-09-13-f-store-hot-swap.md`（**F-HOT 已交付**；DoD 见 `notes/2026-09-13-f-hot-dod-audit.md`）
