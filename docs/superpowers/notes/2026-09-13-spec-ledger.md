...
| 模型思考级别开关 | P1 非目标 → 上调 | **实现计划已就绪** | 规格 [`2026-09-14-llm-think-design.md`](../specs/2026-09-14-llm-think-design.md)；计划 [`2026-09-14-llm-think.md`](../plans/2026-09-14-llm-think.md) |
...
4. ~~**LOGIN-SKILL**~~（已交付，待合入；UI-LOGIN-AT 直达已拆除） · **LLM-THINK**（实现计划已就绪；见 [`2026-09-14-llm-think.md`](../plans/2026-09-14-llm-think.md)） · **BLOB-CS** · **UI-I18N**  
