...
| 模型思考级别开关 | P1 非目标 → 上调 | **范围已确认** | [`2026-09-14-llm-think-design.md`](../specs/2026-09-14-llm-think-design.md)；级别 + 方言 + 真流式思考展示 |
...
4. ~~**LOGIN-SKILL**~~（已交付，待合入；UI-LOGIN-AT 直达已拆除） · **LLM-THINK**（范围已确认；见 [`2026-09-14-llm-think-design.md`](../specs/2026-09-14-llm-think-design.md)） · **BLOB-CS** · **UI-I18N**  
