...
| **BLOB-CS** | **范围已确认** | 规格 [`2026-09-15-blob-cs-design.md`](../specs/2026-09-15-blob-cs-design.md)；Connector/用户·managed Skill → blob；builtin 仍本地 |
...
4. ~~**LOGIN-SKILL**~~（已交付，待合入；UI-LOGIN-AT 直达已拆除） · ~~**LLM-THINK**~~（已交付；见 [`2026-09-14-llm-think.md`](../plans/2026-09-14-llm-think.md)） · **BLOB-CS**（范围已确认；见 [`2026-09-15-blob-cs-design.md`](../specs/2026-09-15-blob-cs-design.md)） · **UI-I18N**  
