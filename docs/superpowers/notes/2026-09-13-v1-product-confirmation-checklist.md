...
| **UI-I18N** | i18n 框架（语言切换 / 英等） | **已交付** | [`specs/2026-09-15-ui-i18n-design.md`](../specs/2026-09-15-ui-i18n-design.md)；计划 [`plans/2026-09-15-ui-i18n.md`](../plans/2026-09-15-ui-i18n.md)；本机 `baize.locale` |
...
| **LOGIN-SKILL**（原 **UI-LOGIN-AT**） | 连接器自动登录 Skill / login_required「去登录」 | **已交付** | 规格 [`specs/2026-09-14-login-skill-design.md`](../specs/2026-09-14-login-skill-design.md)；计划 [`plans/2026-09-14-login-skill.md`](../plans/2026-09-14-login-skill.md)；UI-LOGIN-AT 直达（login-entries / login-invoke / 登录专用区）已拆除 |
...
4. **CH-PORT** → **CH-OUTBOX**  
5. ~~**LOGIN-SKILL**~~（已交付） · ~~**LLM-THINK**~~（已交付） · ~~**BLOB-CS**~~（已交付；见 [`plans/2026-09-15-blob-cs.md`](../plans/2026-09-15-blob-cs.md)） · ~~**UI-I18N**~~（已交付；见 [`plans/2026-09-15-ui-i18n.md`](../plans/2026-09-15-ui-i18n.md)）  
