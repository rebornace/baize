...
| **F** | F + **C1** + **OPS-HOT**（驱动热切换 / SIGHUP / 凭据 KV 加密） | F-C1 已交付；**F-KV 已交付（实现阶段，待合并）** | `plans/2026-09-13-f-kv-encrypt.md`；DoD [`2026-09-13-f-kv-dod-audit.md`](2026-09-13-f-kv-dod-audit.md)；仍欠 **F-HOT** |
