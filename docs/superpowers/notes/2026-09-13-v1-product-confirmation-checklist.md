...
| **BLOB-CS** | Connector / Skill blob 化 | **范围已确认** | 规格 [`specs/2026-09-15-blob-cs-design.md`](../specs/2026-09-15-blob-cs-design.md)；**不合并** |
...
4. **CH-PORT** → **CH-OUTBOX**  
5. ~~**LOGIN-SKILL**~~（已交付，待合入） · ~~**LLM-THINK**~~（已交付） · **BLOB-CS**（范围已确认；见 [`specs/2026-09-15-blob-cs-design.md`](../specs/2026-09-15-blob-cs-design.md)） · **UI-I18N**  
