...
func TestMinRoleTable(t *testing.T) {
	cases := []struct {
		...
		{"POST", "/v0/connectors/c1/mcp/oauth/disconnect", RoleAdmin},
		{"GET", "/v0/connectors/c1/mcp/oauth/status", RoleAdmin},
		...
		{"GET", "/v0/settings/memory", RoleOperator},
		{"POST", "/v0/settings/memory", RoleOperator},
		{"PATCH", "/v0/settings/memory/mem_1", RoleOperator},
		{"DELETE", "/v0/settings/memory/mem_1", RoleOperator},
