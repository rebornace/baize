...
var aclRules = []routeRule{
	...
	{method: "GET", segments: []string{"v0", "conversations", "{id}", "login-entries"}, role: RoleOperator},
	{method: "POST", segments: []string{"v0", "conversations", "{id}", "login-invoke"}, role: RoleOperator},
